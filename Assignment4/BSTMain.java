...
public class BSTMain <E> implements BSTInterface{
    ...
    public static<E> void preOrder(Node node)
    {
        if (node == null)
        {
            return;
    ...
    public static<E> void postOrder(Node node)
    {
        if (node == null)
        {
            return;
    ...
    public static<E> void inOrder(Node node)
    {
        if (node == null)
        {
            return;
    ...
    private E findhelp(Node<E>rt,E value)
    {
        ...
        if(rt.compareTo(value)>0)
        {
            return (E) findhelp(rt.getLeft(),value);
        }
        else if(rt.compareTo(value)==0)
        {
            return rt.getValue();
        ...
        {
            return (E) findhelp(rt.getRight(),value);
        }
    }
